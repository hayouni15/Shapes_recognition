        ...
        if area> 3000 and area< 1180000:
            ...
            if np.prod(roi.shape[:2])>10:
                ...
                if max(prediction)> p_val:
                    ...
                    if prediction[1]>p_val and prediction[1import cv2, numpy as np, os
from keras.models import Sequential
from keras.layers import Dense
from keras.layers import Dropout
...
cap.release()
cv2.destroyAllWindows()ediction[1]
                    if prediction[2]>p_val and prediction[2import cv2, numpy as np, os
from keras.models import Sequential
from keras.layers import Dense
from keras.layers import Dropout
...
cap.release()
cv2.destroyAllWindows()prediction[2]
                    if prediction[3]>p_val and prediction[3import cv2, numpy as np, os
from keras.models import Sequential
from keras.layers import Dense
from keras.layers import Dropout
...
cap.release()
cv2.destroyAllWindows()prediction[3]
                
                #draw the contour
                cv2.drawContours(imgc, c, -1, (0,0,255), 1)import cv2, numpy as np, os
from keras.models import Sequential
from keras.layers import Dense
from keras.layers import Dropout
